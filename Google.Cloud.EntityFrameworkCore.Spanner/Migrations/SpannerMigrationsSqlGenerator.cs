...
namespace Google.Cloud.EntityFrameworkCore.Spanner.Migrations
{
    ...
    internal class SpannerMigrationsSqlGenerator : MigrationsSqlGenerator
    {
            ...
            MigrationCommandListBuilder builder)
        {
            ...
            {
                AppendIdentityOptions(builder, value);
            }
            else if (identityAnnotation is { Value: string stringValue })
            {
                var identityOptions = SpannerIdentityOptionsData.Deserialize(stringValue);
                AppendIdentityOptions(builder, identityOptions);
            }
        ...
        private static void AppendIdentityOptions(MigrationCommandListBuilder builder, SpannerIdentityOptionsData value)
        {
