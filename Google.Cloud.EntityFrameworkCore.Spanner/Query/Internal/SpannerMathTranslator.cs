...
namespace Google.Cloud.EntityFrameworkCore.Spanner.Query.Internal
{
    ...
    {
        private static readonly Dictionary<MethodInfo, string> s_supportedMethods = new()
        {
            ...
            { typeof(Math).GetRuntimeMethod(nameof(Math.Round), [typeof(double), typeof(MidpointRounding)])!, "ROUND" },
            { typeof(Math).GetRuntimeMethod(nameof(Math.Round), [typeof(double), typeof(int), typeof(MidpointRounding)])!, "ROUND" },
            { typeof(Math).GetRuntimeMethod(nameof(Math.Round), [typeof(decimal), typeof(MidpointRounding)])!, "ROUND" },
            { typeof(Math).GetRuntimeMethod(nameof(Math.Round), [typeof(decimal), typeof(int), typeof(MidpointRounding) ])!, "ROUND" },
