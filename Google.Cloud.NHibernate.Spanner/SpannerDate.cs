...
namespace Google.Cloud.NHibernate.Spanner
{
    ...
    /// </summary>
    public sealed class SpannerDate : IUserType, IEquatable<SpannerDate>, IConvertible, IComparable<SpannerDate>
    {
        public int Year { get; }
        ...
        public System.Type ReturnedType => typeof(SpannerDate);
        ...
        {
            cmd.Parameters[index].DbType = DbType.Date;
            if (value is SpannerDate spannerDate)
            {
                cmd.Parameters[index].Value = spannerDate.ToDateTime();
            }
            else
            {
        ...
        public object DeepCopy(object value)
        {
            if (value is SpannerDate spannerDate)
            {
                return new SpannerDate(spannerDate.Year, spannerDate.Month, spannerDate.Day);
            }
            return null;
        }
